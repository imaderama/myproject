...
Route::post('/medicine/index','MedicineController@showInfo')->name('medicine.showInfo');
Route::post('/category/index','CategoryController@showProducts')->name('category.showProducts');
